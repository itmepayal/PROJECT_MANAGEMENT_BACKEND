...
<head>
  ...
  <title>Verify Your Email - Gravity</title>
</head>
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="margin-top:25px;font-size:16px;line-height:28px;color:#4b5563;">
                Welcome to <strong>Gravity</strong>! We're excited to have you on board.
              </p>

              <p style="font-size:16px;line-height:28px;color:#4b5563;">
                To keep your account secure, please verify your email address by entering the verification code below.
              </p>
              ...
              <div style="
                ...
                line-height:24px;
              ">
                ⏳ <strong>This verification code is valid for 10 minutes.</strong>
                <br>
                Please do not share this code with anyone.
              </div>

              <p style="margin-top:35px;font-size:15px;line-height:26px;color:#6b7280;">
                If you didn't create a Gravity account, you can safely ignore this email.
          ...
          <tr>
            <td align="center"
              ...
              <p style="margin:8px 0 0;font-size:12px;color:#9ca3af;">
                This is an automated email from Gravity.
