...
<head>
  ...
  <title>Reset Your Password - Gravity</title>
</head>
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="margin-top:25px;font-size:16px;line-height:28px;color:#4b5563;">
                We received a request to reset the password for your <strong>Gravity</strong> account.
              </p>
              ...
              ">
                ...
                <br>
                If you didn't request a password reset, please ignore this email or contact our support team immediately. Your account is still safe.
              </div>
